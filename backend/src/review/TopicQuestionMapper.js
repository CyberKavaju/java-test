...
class TopicQuestionMapper {
    constructor() {
        ...
        this.topicMapping = {
            ...
            '10-bitwise-operators': ['Using Operators and Decision Constructs', 'Bitwise vs Logical Operators'],
            ...
            '24-map-object': ['HashMap put', 'HashMap get', 'HashMap containsKey', 
                'HashMap size', 'HashMap remove', 'HashMap null key', 'Map', 'Map Object'],
            ...
            '32-methods': ['Working with Methods and Encapsulation', 'Method Overloading'],
            ...
            '40-virtual-vs-non-virtual-methods': ['Working with Inheritance'],
            '41-abstract-classes': ['Working with Inheritance', 'Abstract Class'],
